...
<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="fw-bold" style="color: #4361ee;">Tambah Produk</h2>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-12 mb-3">
                        ...
                        <input type="text" name="nama_produk" class="form-control" placeholder="Masukkan nama produk" value="{{ old('nama_produk') }}" required>
                        @error('nama_produk')
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <select name="kategori" class="form-select" required>
                            ...
                            <option value="Remaja" {{ old('kategori') == 'Remaja' ? 'selected' : '' }}>Remaja</option>
                ...
                <div class="row">
                    <div class="col-12 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" name="harga" class="form-control" placeholder="Masukkan harga umum" value="{{ old('harga') }}" required>
                        </div>
                        @error('harga')
                            <div class="text-danger mt-1">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <input type="number" name="stok" class="form-control" placeholder="Masukkan stok umum" value="{{ old('stok') }}" required>
                        @error('stok')
                            <div class="text-danger mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="bahan" class="form-control" placeholder="Contoh: Katun, Polyester, dll." value="{{ old('bahan') }}" required>
                    @error('bahan')
                        <div class="text-danger mt-1">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea name="deskripsi" class="form-control" rows="4" placeholder="Jelaskan detail produk, keunggulan, dan informasi lainnya." required>{{ old('deskripsi') }}</textarea>
                    @error('deskripsi')
                        <div class="text-danger mt-1">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="d-flex align-items-center mb-3">
                    <div class="form-check form-switch me-2">
                        <input class="form-check-input" type="checkbox" name="pre_order" value="1" id="pre_order_toggle" {{ old('pre_order') ? 'checked' : '' }}>
